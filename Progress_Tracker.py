...
class Task:
    def __init__(self, title, deadline_str, progress=0):
        self.title = title
        self.deadline = datetime.datetime.strptime(deadline_str, config.time_format)  # ⏰ Pakai konfigurasi global
    ...
    def __str__(self):
        # 📄 Generalisasi output tugas, cocok untuk UI atau CLI
...
# ==============================
# ♻️ FUNGSI YANG DIGUNAKAN ULANG
# ==============================
def print_task_list(tasks):
    # ♻️ Code Reuse: mencetak daftar tugas, bisa digunakan di mana saja
...
if __name__ == "__main__":
    ...
    print_task_list(daftar_tugas)  # ♻️ Code reuse
